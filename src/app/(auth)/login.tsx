...
export default function LoginScreen() {
  ...
  const { signInWithEmail, signInWithGoogle, isLoading } = useSupabase()
  ...
  const handleEmailLogin = async () => {
    ...
    if (response?.error) {
      Alert.alert(translate("auth:login.loginFailed"), response.error.message)
  ...
  return (
    ...
    >
      <View style={themed($topContainer)}>
        ...
        <Text preset="heading" tx="auth:login.title" style={themed($title)} />
        <Text preset="subheading" tx="auth:login.subtitle" style={themed($subtitle)} />
        ...
        <View style={themed($dividerContainer)}>
          ...
          <Text tx="auth:login.orDivider" style={themed($dividerText)} />
          <View style={themed($divider)} />
        </View>

        <Button
          tx="auth:login.continueWithGoogle"
          preset="default"
      ...
      <View style={themed([$bottomContainer, $bottomContainerInsets])}>
        <Text style={themed($footerText)}>
          <Text tx="auth:login.noAccount" />
          {" "}
          <Text
            tx="auth:login.signUpLink"
            style={themed($link)}
